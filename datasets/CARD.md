...
|---|---|---|---|---|---|
| `cve_to_cwe` | **예** | 170,748 | 28,491 | 3,673 | 3,384 |
| `cvss_vector` | **예** | 123,402 | 20,591 | 4,333 | 4,160 |
| `attack_technique` | **아니오** (`scored: false`) | 738 | — | 79 | 67 |
| `structured_extract` | **예** | 65,429 | 10,918 | 3,117 | 1,831 |
