...
| **nvidia/HelpSteer2 (evaluated as replay top-up -- NOT USED)** — **미사용** | 가능 (출처 표기 조건) | 문서에 언급 없음 | 가능 | 예 | [https://huggingface.co/datasets/nvidia/HelpSteer2](https://huggingface.co/datasets/nvidia/HelpSteer2) | [Creative Commons Attribution 4.0 (declared in the dataset card: `license: cc-by-4.0`)](https://huggingface.co/datasets/nvidia/HelpSteer2/blob/main/README.md) | 2026-09-19 |
...
| `replay_helpsteer2_not_used` | Creative Commons Attribution 4.0 (declared in the dataset card: `license: cc-by-4.0`) | Prompts: mostly user-contributed ShareGPT plus ~5% written by Scale AI. Responses: generated by in-house NVIDIA LLMs. The response turns are therefore model-generated, not human-written. |
...
### nvidia/HelpSteer2 (evaluated as replay top-up -- NOT USED)

- 라이선스 문서: <https://huggingface.co/datasets/nvidia/HelpSteer2/blob/main/README.md> (확인 일자 2026-09-19)
- 재배포: **가능 (출처 표기 조건)** / 상업적 이용: **가능**
- 근거 인용:
...
- **학습 가중치 공개(`model_publication_status`): 문서에 언급 없음**
  - 확인한 내용: CC BY 4.0 does not mention machine learning, training, or model weights.
...
- PII 정책: not applicable -- not downloaded; would be subject to the P2 scan if it ever were
